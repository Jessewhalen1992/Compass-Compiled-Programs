...
public class UnifiedPaletteHost : IExtensionApplication
{
    ...
    public static void EnsurePalette()
    {
        ...
        _mainPalette.MinimumSize = new System.Drawing.Size(320, 240);
    }
    ...
    public static bool AddTab(string name, UserControl control)
    {
        ...
        if (TabIndices.ContainsKey(name))
        {
            return false;
        }

        _mainPalette.AddVisual(name, control);
        TabIndices[name] = _mainPalette.PaletteCount - 1;
        return true;
    }
    ...
    public static void ShowPalette(string? tabName = null)
    {
        ...
        else if (_mainPalette.PaletteCount > 0)
        {
    ...
    public static void ShowUnifiedPalette()
    {
        ShowPalette();
    }
}
